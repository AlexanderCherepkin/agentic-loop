...
Loop orchestration commands (`/goal`, `/loop`, `/workflows`) are routed through `goal_planner_v2.md`, `loop_planner.md`, and `loop_trust_levels.md` for trust-level gating and cost guard.
