...
**Масштаб:** 256 агента/файла, 6 слоёв, 12 категорий инструментов + Figma-to-code MCP сервер + Backend Spec Bridge MCP сервер.
...
### 2.6 Подагенты цикла ReAct (tooll_subagents) — 100 агентов
...
- 256/256 агента/файла реализовано.
- 0 stubs.
- 0 изолированных агентов.
