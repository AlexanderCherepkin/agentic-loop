...
function main() {
  ...
  const knownFalsePositives = ['README', 'API', 'CHANGELOG', 'MEMORY', 'project_rules', 'DESIGN', '_spec', 'SKILL', 'schema', 'index'];
  const docFiles = ['ARCHITECTURE.md', 'TECHNICAL_ASSIGNMENT.md', 'CLAUDE.md', 'TECHNICAL.md'];
